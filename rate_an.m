...
% at Rm=0.358
% box 20: /snoopy/kinematicOutput/rates1
% box 10: /snoopy/kinematicOutput_rm_Op368/rates1/

% at Rm=0.28
% box 16 white noise: u_abc/box_16/snoopy/kinematicOutput_rm_0p27/rate2
% box 16 k=(1,1,1)  : dif_init_conds/u_abc/box_16/snoopy/kinematicOutput/rate2 
 
% modified:
% box 8: /data/novadisk/vs391/snoopy_kinematic_dynamo/modified_abc/box_8/snoopy/kinematicOutput_rm_1p2
 ...
 for constt =3
    for const =0
        fprintf('Begin: rates%d/rates_r0%d\n', constt, const);
         ...
         box_ar = 8;
         filename_out = ['/data/novadisk/vs391/snoopy_kinematic_dynamo/modified_abc/box_' num2str(box_ar) '/snoopy/kinematicOutput_rm_0p7/rates' num2str(constt) '/modes_r0' num2str(const) '.txt'];
         filename_in  = ['/data/novadisk/vs391/snoopy_kinematic_dynamo/modified_abc/box_' num2str(box_ar) '/snoopy/kinematicOutput_rm_0p7/rates' num2str(constt) '/rates_r0' num2str(const) '.txt'];
         filename_rm  = ['/data/novadisk/vs391/snoopy_kinematic_dynamo/modified_abc/box_' num2str(box_ar) '/snoopy/kinematicOutput_rm_0p7/timevar' num2str(constt) '.dat'];
